package com.app.MavenSpringBootAopBeforeAfterAdviceWithPointcutThruAspectJXml;
...
public class MavenSpringBootAopBeforeAfterAdviceWithPointcutThruAspectJXmlApplication {

	public static void main(String[] args) throws Exception {
		ApplicationContext context = SpringApplication.run(MavenSpringBootAopBeforeAfterAdviceWithPointcutThruAspectJXmlApplication.class, args);
