...
public class CustomerAspectJoinPoint {
	...
	@Before("execution(* com.app.MavenSpringBootMvcAopAllAdviceWithPointcutExpressionsThruAspectJ.service.CustomerAdvanceService.*(..)) && args(firstName, id)")
	public void logStringArguments(String firstName, long id) {
		System.out.println("Passed Arguments: [" + "firstName = " + firstName + "; id = " + id + "]");
	}

	@Before("execution(* com.app.MavenSpringBootMvcAopAllAdviceWithPointcutExpressionsThruAspectJ.service.CustomerAdvanceService.setCustomerFirstName(..))")
	...
	@Around("execution(* com.app.MavenSpringBootMvcAopAllAdviceWithPointcutExpressionsThruAspectJ.service.CustomerAdvanceService.findAllCustomers())")
