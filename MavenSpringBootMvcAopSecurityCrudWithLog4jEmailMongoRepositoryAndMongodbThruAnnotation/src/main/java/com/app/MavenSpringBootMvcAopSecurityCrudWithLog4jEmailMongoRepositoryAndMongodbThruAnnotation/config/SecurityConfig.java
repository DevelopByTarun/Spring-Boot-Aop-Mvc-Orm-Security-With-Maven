...
@ComponentScan(basePackages = "MavenSpringBootMvcAopSecurityCrudWithLog4jEmailMongoRepositoryAndMongodbThruAnnotation")
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) {
		try {
             ...
             .antMatchers("/", "/*company*/**").access("hasRole('USER')").and()
             .formLogin()
             .and()
             .logout();
			 http.exceptionHandling().accessDeniedPage("/accessdenied-company");
