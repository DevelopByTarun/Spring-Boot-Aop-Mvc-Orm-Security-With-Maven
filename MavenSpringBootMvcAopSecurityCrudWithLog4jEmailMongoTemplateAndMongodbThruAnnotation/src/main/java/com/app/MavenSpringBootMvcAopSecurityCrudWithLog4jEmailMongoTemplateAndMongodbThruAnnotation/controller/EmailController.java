...
public class EmailController {
	...
	@RequestMapping(value = "/email-customer-account", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/sendEmailWithAttachment-customer-account", method = RequestMethod.POST)
	public ModelAndView sendEmailThroughSpring(@RequestParam("from") String from, 
		...
		mimeHelper.addAttachment("pdf", getFile);
