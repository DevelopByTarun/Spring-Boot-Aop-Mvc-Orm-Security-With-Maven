package com.app.MavenSpringBootMvcAopSecurityCrudWithLog4jEmailMongoTemplateAndMongodbThruAnnotation.service;
...
public class CustomerAccountService implements ICustomerAccountDAO {
    ...
    public void updateCustomerAccountDetails(CustomerDTO customeraccountDTO) throws Exception {
        ...
        getCustomerAccount.setCustomerId(customeraccountDTO.getCustomerId());
