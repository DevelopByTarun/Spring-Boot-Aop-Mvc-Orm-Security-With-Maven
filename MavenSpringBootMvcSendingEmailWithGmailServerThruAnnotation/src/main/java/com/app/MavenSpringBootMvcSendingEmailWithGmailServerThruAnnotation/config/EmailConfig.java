package com.app.MavenSpringBootMvcSendingEmailWithGmailServerThruAnnotation.config;
...
@ComponentScan(basePackages = "com.app.MavenSpringBootMvcSendingEmailWithGmailServerThruAnnotation")
